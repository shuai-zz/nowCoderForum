 ...
 */
public record PostItem(DiscussPost discussPost, AuthorRef author, long likeCount, int likeStatus) {
    public static PostItem of(DiscussPost discussPost, AuthorRef author, long likeCount, int likeStatus) {
