...
import org.example.nowcoder.entity.dto.SendLetterRequest;
import org.example.nowcoder.entity.vo.ConversationDetailVO;
import org.example.nowcoder.entity.vo.ConversationVO;
import org.example.nowcoder.entity.vo.LetterVO;
    ...
    public Result<PageResult<ConversationVO>> conversations(
        ...
        if (page.getList() != null) {
            for (Message c : page.getList()) {
                ...
                UserVO target = UserVO.from(userService.findUserById(targetId));
    ...
    public Result<ConversationDetailVO> conversationDetail(
        ...
        if (page.getList() != null) {
            for (Message m : page.getList()) {
                UserVO from = UserVO.from(userService.findUserById(m.getFromId()));
